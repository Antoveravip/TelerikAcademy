/* Task 8: Implement an UnstoppableBall and an UnpassableBlock. The UnstopableBall 
 * only bounces off UnpassableBlocks and will destroy any other block it passes
 * through. The UnpassableBlock should be indestructible. Hint: Take a look at the 
 * RespondToCollision method, the GetCollisionGroupString method and the CollisionData 
 * class.
 */
