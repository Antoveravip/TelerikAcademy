/* Lesson 3 - Defining Classes Part II - Static Members, Generics
 * 
 * Homework 1
 * 
 ...
 * Homework 3
 * 
 * Write a static class with a static method to calculate the distance
 ...
 * Homework 6
 * 
 * Implement auto-grow functionality: when the internal array is full, create 
 * a new array of double size and move all elements to it.
 * 
 * 
 * Homework 7
 * 
 * Create generic methods Min<T>() and Max<T>() for finding the minimal and maximal
 * element in the  GenericList<T>. You may need to add a generic constraints for 
 * the type T.
 * 
 * 
 * Homework 8
