 ...
 * Homework 5
 * 
 * Use properties to encapsulate the data fields inside the GSM, Battery
 * and Display classes. Ensure all fields hold correct data at any given time. 
 * 
 * 
 * Homework 6
 * 
 * Add a static field and a property IPhone4S in the GSM class to hold the 
 ...
 * Homework 8
 * 
 * Create a class Call to hold a call performed through a GSM. It 
 * should contain date, time, dialed phone number and duration
 * (in seconds).
 * 
 * 
 * Homework 9
 ...
 * Homework 10
 * 
 * Add methods in the GSM class for adding and deleting calls from
 * the calls history. Add a method to clear the call history.
 * 
 * 
 * Homework 11
 * 
 * Add a method that calculates the total price of the calls in the 
 * call history. Assume the price per minute is fixed and is provided 
 * as a parameter.
 * 
 * 
 * Homework 12
