...
namespace SolarSystem
{
    class OrbitsCalculator : INotifyPropertyChanged
    {
        ...
        // I found this source code which cause significant performance degradation (bottlenecks)!
        // Just remove entire for cicle - no need from him - the result of that cicle is aways the same:
        // EarthRotationAngle = 360 * Days / EarthRotationPeriod;
        // EarthRotationPeriod - at this logic of code and use of this const - no need from this - will be always = 1;S
